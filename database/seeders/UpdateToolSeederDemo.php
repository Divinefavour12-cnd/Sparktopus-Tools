            ...
            [
                ...
                'tools' => [
                    ...
                    [
                        ...
                        'icon_type' => 'class',
                        'icon_class' => 'organize-pdf-tool',
                        'settings' => ['driver' => 'ILovePdf', 'love_pdf_public_id' => 'your_ilovepdf_public_id', 'love_pdf_secret_key' => 'your_ilovepdf_secret_key'],
            ...
            [
                ...
                'tools' => [
                    [
                        ...
                        'settings' => ['driver' => 'GoogleSearchApi', 'google_Search_apikey' => 'your_google_search_api_key', 'google_Search_cx' => 'your_google_search_cx'],
                        'properties' => ["properties" => ["du-tool"], "auth" => ["du-tool" => $du_tool_value_auth], "guest" => ["du-tool" => $du_tool_value_guest]],
