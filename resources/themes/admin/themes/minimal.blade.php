            ...
            <div class="col-md-9">
                <div class="input-group colorPicker">
                    <input type="text" id="primary_color" class="form-control"
                        ...
                        value="{{ $themeOptions->light->primary_color ?? '#6000C2' }}" />
                    <span class="input-group-append"
                        style="background-color:{{ $themeOptions->light->primary_color ?? '#6000C2' }}">
                        <x-color-picker :color="$themeOptions->light->primary_color ?? '#6000C2'" />
                    </span>
                </div>
                <span class="help-block text-muted small">@lang('settings.primaryColorHelp')</span>
                <span class="help-block text-muted small">@lang('settings.defaultValue', ['value' => '#6000C2'])</span>
            </div>
        </div>
        <div class="form-group row mb-3">
