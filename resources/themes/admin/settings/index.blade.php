                                ...
                                <div class="form-group mb-3 row">
                                    ...
                                    <div class="col-md-9">
                                        <input id="twitter_username" type="text"
                                            ...
                                            value="{{ setting('twitter_username', 'SparktopusTools') ?? '' }}" required>
                        ...
                        <div class="form-group mb-3 row">
                            ...
                            <div class="col-md-9" data-conditional-name="settings[footer_copyright_bar]">
                                <textarea id="_footer_copyright" type="text" rows="9"
                                    ...
                                    name="settings[_footer_copyright]">{{ setting('_footer_copyright', '© 2022 - 2026 <a href="https://www.tools.sparktopus.com/">Sparktopus Tools</a>. All rights reserved. <a href="https://www.tools.sparktopus.com/">Sparktopus Tools</a> is a product of <a href="https://www.sparktopus.com/">Sparktopus</a> Inc.') ?? '' }}</textarea>
                            ...
                            axios.get($url)
                                .then(function(response) {
                                    if (response.data.success) {
                                        SparktopusTools.sweetSuccess(response.data.message);
                                    }
                                })
