<x-app-layout>
    <x-manage-filters :button="__('common.createNew')" :route="route('admin.updates.create')" :search="true" :search-route="route('admin.updates')" />
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center justify-content start">
                                            ...
                                            <form action="{{ route('admin.updates.destroy', $post->id) }}" method="POST"
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                    <li>
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.updates.featured', ['post' => $post->id, 'id' => '1']) }}">
                                                            <i class="lni lni-diamond-alt"></i>
                                                            {{ $post->featured == 1 ? __('admin.removeFeatured') : __('admin.featured') }}</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.updates.featured', ['post' => $post->id, 'id' => '2']) }}">
