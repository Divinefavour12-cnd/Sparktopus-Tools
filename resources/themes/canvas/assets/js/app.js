...
const ArtisanApp = function () {
    ...
    return {
        ...
        initSidebar: function () {
            ...
            const mainWrapper = document.querySelector('.dashboard-wrapper');
            ...
            if (collapseToggle && sidebar) {
                collapseToggle.addEventListener('click', () => {
                    ...
                    Cookies.set('sidebarCollapsed', isCollapsed ? 'true' : 'false', { expires: 365 });
                });

                // Apply saved state
                if (Cookies.get('sidebarCollapsed') === 'true') {
