                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <select name="from_unit" id="unit_1" required class="form-select border-0 bg-light py-3 rounded-3 shadow-sm">
                                    <option>Degrees Celsius ('C)</option>
                                    <option>Degrees Fahrenheit ('F)</option>
                                    <option>Degrees Kelvin ('K)</option>
                                    <option>Degrees Rankine ('R)</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
            ...
            const APP = function() {
                ...
                const attachEvents = function() {
                        ...
                        document.querySelector('#unit_1').addEventListener('change', () => {
                            document.getElementById('fromUnit').innerHTML = document.querySelector('#unit_1')
                                .value
                            CalculateUnit('1', '2');
                        });
                        document.querySelector('#unit_2').addEventListener('change', () => {
                            document.getElementById('toUnit').innerHTML = document.querySelector('#unit_2')
                                .value
                            CalculateUnit('1', '2');
                        });
                    },
