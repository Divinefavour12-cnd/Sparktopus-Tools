...
class ThemesController extends Controller
{
    ...
    protected function install(Request $request)
    {
        ...
        if (!in_array($themeJson->get('category', false), array('front', 'admin'))) {
            return redirect()->back()->withErrors(__('This is not a valid package for Sparktopus Tools, please contact theme author for support.'));
        }
    ...
    {
        // $link = 'https://verify.SparktopusTools.com/check';
        // $response = Http::post($link, ['version' => setting('version'), 'item'  => "sparktopus_tools"]);
        // $data = $response;
