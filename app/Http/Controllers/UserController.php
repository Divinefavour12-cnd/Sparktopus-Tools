...
class UserController extends Controller
{
    ...
    {
        $user = Auth::user();
        Meta::setMeta((object) ["title" => "Tool History", "description" => "Your tool usage history"]);
        
        $toolUsages = $user->toolUsages()
            ->orderBy('last_used_at', 'desc')
            ->paginate(20);
        
        return view('user.history', compact('user', 'toolUsages'));
    }
    ...
    public function notifications()
    {
        ...
        Meta::setMeta((object) [
            'title' => __('Notifications') . ' - ' . config('app.name'),
            'description' => __('Stay updated with your subscription status and tool usage limits.')
        ]);
    ...
    public function markAllAsRead()
    {
        ...
        return redirect()->back()->withSuccess(__('All notifications marked as read.'));
    }
}
